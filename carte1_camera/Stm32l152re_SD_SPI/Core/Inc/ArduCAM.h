...
#define ARDUCAM_SPI					(&hspi1)

#define ARDUCAM_SPI_CS_PIN_PORT		GPIOA
#define ARDUCAM_SPI_CS_PIN_NUMBER		GPIO_PIN_4
...
#define OV2640_I2C_ADDRESS  0x30  // Adresse I2C 7 bits du capteur
